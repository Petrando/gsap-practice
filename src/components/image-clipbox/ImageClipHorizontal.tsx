...
const ImageClipHorizontal: FC<Props> = ({ parentRef, src, clipClass = "", slices = 8 }) => {
    ...
    useEffect(() => {
        ...
        slicesEl.forEach((slice, i) => {
            ...
            gsap.to(slice, {
                x: toX, opacity: 0, duration: 0.8, ease: "power3.in",
...
export default ImageClipHorizontal;
